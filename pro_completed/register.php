            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_name" name="c_name" placeholder="Enter your Date"
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4 mt-3 mt-lg-0">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_email" name="c_email" placeholder="Enter your Year" 
						required pattern="19[5-9][\d*]|200[0-1]">
                    </div>
                </div>
            </div>
            <div class="row my-3">
